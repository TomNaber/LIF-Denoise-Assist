...
def get_output_directory():
    messagebox.showinfo("LIF Denoise Assist - output folder", "Please select folder in which to store the image slices. Press 'OK' to continue")
...
def main():
    ...
    process_lif_files_with_pb(liffiles, input_dir, output_dir, total_slices, total_stacks, progressbar, progress_label,
                              file_label)
    root.destroy()
    return input_dir, output_dir, total_stacks, total_slices
